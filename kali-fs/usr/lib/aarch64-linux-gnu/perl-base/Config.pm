...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/aarch64-linux-gnu/perl/5.40',
    ...
    osvers => '6.1.0',
    path_sep => ':',
    privlibexp => '/usr/share/perl/5.40',
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib/aarch64-linux-gnu/perl/5.40.0',
    sitelibexp => '/usr/local/share/perl/5.40.0',
    so => 'so',
    useithreads => 'define',
